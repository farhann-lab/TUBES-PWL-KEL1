<aside
    ...
    <nav class="flex-1 px-3 overflow-y-auto overflow-x-hidden hide-scrollbar space-y-0.5 py-1">
        ...
        <a href="{{ route('admin.dashboard') }}"
           ...
           {{ request()->routeIs('admin.dashboard') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
        ...
        <a href="{{ route('admin.stocks.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.stocks*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
            <i class="ph ph-package text-xl flex-shrink-0"></i>
            <span class="elco-label-transition overflow-hidden whitespace-nowrap"
                  :class="open ? 'max-w-[140px] opacity-100' : 'max-w-0 opacity-0'">Stok Cabang</span>
        </a>

        {{-- Pengajuan Kebutuhan --}}
        <a href="{{ route('admin.stock-requests.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.stock-requests*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
            <i class="ph ph-arrow-circle-up text-xl flex-shrink-0"></i>
            <span class="elco-label-transition overflow-hidden whitespace-nowrap"
                  :class="open ? 'max-w-[140px] opacity-100' : 'max-w-0 opacity-0'">Pengajuan Kebutuhan</span>
        </a>

        {{-- Pengeluaran --}}
        <a href="{{ route('admin.expenses.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.expenses*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
        ...
        <a href="{{ route('admin.promotions.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.promotions*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
            <i class="ph ph-tag text-xl flex-shrink-0"></i>
            <span class="elco-label-transition overflow-hidden whitespace-nowrap"
                  :class="open ? 'max-w-[140px] opacity-100' : 'max-w-0 opacity-0'">Promo Cabang</span>
        </a>

        {{-- Laporan Bulanan --}}
        <a href="{{ route('admin.reports.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.reports*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
            <i class="ph ph-chart-bar text-xl flex-shrink-0"></i>
            <span class="elco-label-transition overflow-hidden whitespace-nowrap"
                  :class="open ? 'max-w-[140px] opacity-100' : 'max-w-0 opacity-0'">Laporan Bulanan</span>
        </a>

        {{-- Transaksi --}}
        <a href="{{ route('admin.transactions.index') }}"
           class="elco-nav-item flex items-center gap-3 px-[14px] py-[11px] rounded-2xl font-medium smooth-transition mb-0.5 no-underline
           {{ request()->routeIs('admin.transactions*') ? 'elco-nav-active' : 'text-[rgba(80,50,25,0.6)]' }}"
           :class="open ? '' : 'justify-center !px-0 !gap-0'">
